...
- `resources/css/grapesjs/**`
- `resources/css/landing.css`, `theme.css`, etc.

Installer/docs (`docs/BUILD.md`, `ConfigureViteForVoodbuilder`) describe host wiring. **Do not patch GrapesJS in node_modules.**
...
| `bin/build-tabler-icons-catalog.js` | node | `resources/js/grapesjs/generated/tabler-icons-full.json` |
...
- GrapesJS source tree ≈ 1.8MB JS (pre-minify)
