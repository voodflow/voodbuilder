...
class VoodbuilderSeeder extends Seeder
{
    public function run(): void
    {
        VoodbuilderSettings::query()->firstOrCreate(
            ['id' => 1],
    ...
    protected function seedPermissions(): void
    {
        ...
        $permissionName = (string) config('voodbuilder.permissions.page_builder', 'builder');
    ...
    protected function themeDemoMenuItems(): array
    {
        ...
        $blogItem = Route::has('blog.index')
            ? [
                'label' => __('voodbuilder::demo.blog.title'),
                'type' => MenuItemType::Route,
                'link' => 'blog.index',
                'route_match' => 'blog.*',
                'sort_order' => 20,
        ...
        return [
            $blogItem,
            [
                'label' => __('voodbuilder::demo.news.title'),
                'type' => MenuItemType::Page,
                'link' => 'news',
                'sort_order' => 30,
            ],
