...
function appendInteractionAnimationModifierOverrides(css, html) {
    ...
    const MODIFIER_DECLS = {
        ...
        'animate-duration-5000': 'animation-duration: 5s',
        'animate-duration-8000': 'animation-duration: 8s',
        'animate-duration-10000': 'animation-duration: 10s',
        'animate-duration-15000': 'animation-duration: 15s',
        'animate-duration-20000': 'animation-duration: 20s',
        'animate-duration-30000': 'animation-duration: 30s',
