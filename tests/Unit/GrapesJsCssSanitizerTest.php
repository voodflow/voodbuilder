...
use Voodflow\Vpress\Support\GrapesJs\GrapesJsCssSanitizer;
...
class GrapesJsCssSanitizerTest extends TestCase
{
    ...
    {
        $css = '.text-vp-text-2.body-font.vpress-gjs-section.bg-vp-bg{background-image:url("/storage/vpress/grapesjs/test.jpg");}';
    ...
    {
        $css = '#iyeh{background-image:url("/storage/vpress/grapesjs/test.jpg");}';
