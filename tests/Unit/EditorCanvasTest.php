...
class EditorCanvasTest extends TestCase
{
    public function test_events_sub_theme_uses_theme_background_variables(): void
    {
        ...
        $this->assertStringContainsString(
            "html[data-voodbuilder-editor-scope='layout'] header[role='banner']",
            $frameStyle,
        );
        $this->assertStringContainsString(
    ...
    public function it_converts_absolute_vite_assets_to_root_relative_urls(): void
    {
        $this->assertSame(
            ...
            EditorCanvas::toRootRelativeAssetUrl('http://localhost:8006/build/assets/theme.css'),
        );
        $this->assertSame(
            '/build/assets/theme.css?v=1',
            EditorCanvas::toRootRelativeAssetUrl('https://example.test/build/assets/theme.css?v=1'),
        );
        $this->assertSame(
            '/build/assets/theme.css',
            EditorCanvas::toRootRelativeAssetUrl('/build/assets/theme.css'),
        );
    }
}
