...
use Voodflow\Voodbuilder\Support\Editor\EditorStepTabsNormalizer;
use Voodflow\Voodbuilder\Tests\TestCase;

class EditorStepTabsNormalizerTest extends TestCase
{
...
HTML;
        ...
        $normalized = EditorStepTabsNormalizer::normalize($html);
