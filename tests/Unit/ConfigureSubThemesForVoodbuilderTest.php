...
class ConfigureSubThemesForVoodbuilderTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->configPath = config_path('voodbuilder.php');
    ...
    public function test_it_upserts_sibling_entries_without_nesting_inside_existing_theme(): void
    {
        ...
        $registered = ConfigureSubThemesForVoodbuilder::upsertInConfig('polito2', [
            'label' => 'Polito BIS',
            'description' => 'Clone',
            'capabilities' => ['landing'],
            'layouts' => [
                'home' => 'voodbuilder.themes.polito2.layouts.home',
                'landing' => 'voodbuilder.themes.polito2.layouts.landing',
                'page' => 'voodbuilder.themes.polito2.layouts.page',
            ],
            'css' => 'resources/voodbuilder/themes/polito2/theme.css',
        ]);
    ...
    public function test_register_in_config_skips_existing_theme_ids(): void
    {
        ...
        $registered = ConfigureSubThemesForVoodbuilder::registerInConfig('site', [
    ...
    public function test_remove_from_config_deletes_a_theme_entry(): void
    {
        ...
        $removed = ConfigureSubThemesForVoodbuilder::removeFromConfig('site');
...
return [
    'sub_themes' => [
        'polito' => [
            ...
            'capabilities' => ['landing'],
            'layouts' => [
                'home' => 'voodbuilder.themes.polito.layouts.home',
                'landing' => 'voodbuilder.themes.polito.layouts.landing',
                'page' => 'voodbuilder.themes.polito.layouts.page',
            ],
...
return [
    'sub_themes' => [
        'site' => [
            ...
            'css' => 'resources/voodbuilder/themes/site/theme.css',
        ],
    ],
];
PHP;
