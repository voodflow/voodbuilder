...
class GrapesJsPageTemplateBundleTest extends TestCase
{
    public function test_build_export_payload_includes_generator_metadata(): void
    {
        $payload = GrapesJsPageTemplateBundle::buildExportPayload([]);

        $this->assertSame(GrapesJsPageTemplateBundle::FORMAT_VERSION, $payload['format_version']);
    ...
    public function test_serialize_template_omits_null_description(): void
    {
        ...
        $entry = GrapesJsPageTemplateBundle::serializeTemplate($template);
    ...
    {
        $entries = GrapesJsPageTemplateBundle::extractTemplates([
            'name' => 'Home',
    ...
    public function test_rejects_import_from_unsupported_format(): void
    {
        ...
        GrapesJsPageTemplateBundle::assertImportable([
    ...
    public function test_rejects_import_from_newer_format_version(): void
    {
        ...
        GrapesJsPageTemplateBundle::assertImportable([
            'format' => GrapesJsPageTemplateBundle::FORMAT,
            'format_version' => GrapesJsPageTemplateBundle::FORMAT_VERSION + 1,
        ]);
    }
}
