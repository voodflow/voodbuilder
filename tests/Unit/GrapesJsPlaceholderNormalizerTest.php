...
use Voodflow\Voodbuilder\Support\GrapesJs\GrapesJsPlaceholderNormalizer;
use Voodflow\Voodbuilder\Tests\TestCase;

class GrapesJsPlaceholderNormalizerTest extends TestCase
{
    public function test_normalize_data_image_src_encodes_literal_spaces_for_chrome(): void
    {
        ...
        $normalized = GrapesJsPlaceholderNormalizer::normalizeDataImageSrc($html);
