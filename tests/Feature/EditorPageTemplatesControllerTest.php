...
class EditorPageTemplatesControllerTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_admin_can_store_and_list_page_templates(): void
    {
        ...
        $this->getJson(route('voodbuilder.editor.page-templates.index'))
            ->assertOk()
    ...
    public function test_admin_can_delete_page_template(): void
    {
        ...
        $this->deleteJson(route('voodbuilder.editor.page-templates.destroy', $template))
            ->assertOk()
    ...
    {
        $this->postJson(route('voodbuilder.editor.page-templates.store'), [
            'name' => 'Guest template',
