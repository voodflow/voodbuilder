<label class="voodbuilder-themes-ws__card voodbuilder-themes-ws__card--import voodbuilder-themes-ws__import-label" wire:loading.class="is-importing" wire:target="importArchive">
    ...
    <div class="voodbuilder-themes-ws__card-body">
        <span class="voodbuilder-themes-ws__card-name">{{ __('voodbuilder::settings.theme_workspace_import_card_title') }}</span>
        <span class="voodbuilder-themes-ws__card-badge">{{ __('voodbuilder::settings.theme_workspace_import_card_subtitle') }}</span>
        <span class="voodbuilder-themes-ws__import-loading" wire:loading wire:target="importArchive">
