...
<div class="container mx-auto px-5 py-16 text-center">
    <div class="mx-auto max-w-lg">
        ...
        <nav class="mt-6 flex flex-wrap justify-center gap-x-6 gap-y-2" data-voodbuilder-menu="footer" aria-label="{{ __('Footer') }}"></nav>
        <p class="mt-8 text-xs text-vp-text-3" data-voodbuilder-footer-copyright>
