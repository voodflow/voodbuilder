...
<div class="container mx-auto px-5 py-8">
    <div class="flex flex-col items-center sm:flex-row">
        <div class="shrink-0" data-vpress-brand></div>
        <p class="mt-4 text-sm text-vp-text-2 sm:ml-4 sm:mt-0 sm:border-l sm:border-vp-divider sm:py-2 sm:pl-4" data-vpress-footer-copyright>
            &copy; {{ date('Y') }} {{ $brandName }}
        </p>
        <span class="mt-4 inline-flex justify-center gap-3 sm:ml-auto sm:mt-0 sm:justify-start" data-vpress-footer-social>
