...
<footer class="text-gray-600 body-font vp-landing-footer-tailblocks vp-landing-footer-tailblocks--c">
    <div class="container px-5 py-24 mx-auto">
        @if ($columns !== [])
            <div class="flex flex-wrap md:text-left text-center -mb-10 -mx-4">
                @foreach ($columns as $column)
                    @include('voodbuilder::blocks.landing.partials.tailblocks-column', [
                        'column' => $column,
