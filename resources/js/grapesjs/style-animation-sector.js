...
function fieldHtml({ label, selectAttr, addAttr, options, addLabel }) {
    return `
        <div class="gjs-sm-property voodbuilder-gjs-anim-property">
            <div class="gjs-sm-label"><span class="gjs-sm-label-text">${label}</span></div>
            <div class="gjs-fields">
                <div class="voodbuilder-gjs-anim-combobox">
                    <select class="voodbuilder-gjs-input voodbuilder-gjs-input--select" ${selectAttr}>
                        ${optionsHtml(options)}
                    </select>
                    <button type="button" class="voodbuilder-gjs-anim-combobox__add" ${addAttr}>
                        ${addLabel}
                    </button>
                </div>
            </div>
...
function tabButtonHtml(id, title, icon) {
    return `
        <button type="button"
            class="voodbuilder-gjs-anim-tab"
...
function panelHtml(id, fields, { active = false } = {}) {
    return `
        <div class="voodbuilder-gjs-anim-panel${active ? ' is-active' : ''}"
...
function buildAnimationSector(editor, labels = {}) {
    ...
    sector.className = 'gjs-sm-sector voodbuilder-gjs-sm-sector-animation';
    ...
    sector.innerHTML = `
        <div class="gjs-sm-title gjs-sm-sector-title" data-voodbuilder-anim-toggle role="button" tabindex="0" aria-expanded="false">
            <span class="voodbuilder-gjs-inspector-sector__caret" aria-hidden="true"></span>
            <span class="gjs-sm-sector-label voodbuilder-gjs-sm-sector-animation__label">${labels.classAnimationTitle ?? 'Animation'}</span>
        </div>
        <div class="gjs-sm-properties voodbuilder-gjs-sm-sector-animation__body" hidden>
            <div class="voodbuilder-gjs-anim-tabs" role="tablist" aria-label="${labels.classAnimationTitle ?? 'Animation'}">
            ...
            <div class="voodbuilder-gjs-anim-panels">
                ${panelHtml('preset', `
                    ${fieldHtml({
    ...
    const body = sector.querySelector('.voodbuilder-gjs-sm-sector-animation__body');
