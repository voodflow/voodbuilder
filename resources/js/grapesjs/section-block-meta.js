...
export const SECTION_BLOCK_LABELS = {
    ...
    'site_nav_with_search_dark': 'Navbar · search dark',
    'site_nav_with_action': 'Navbar · quick action',
    'site_nav_with_action_dark': 'Navbar · action dark',
    'site_nav_centered_links': 'Navbar · centered',
    'site_nav_menu_left': 'Navbar · menu left',
    'site_footer_columns_mission': 'Footer · mission + cols',
    'site_footer_columns_brand_end': 'Footer · cols + brand',
    'site_footer_columns_simple': 'Footer · 4 columns',
    'site_footer_columns_cta': 'Footer · CTA + cols',
    'site_footer_columns_newsletter': 'Footer · newsletter + cols',
    'site_footer_columns_newsletter_below': 'Footer · newsletter below',
