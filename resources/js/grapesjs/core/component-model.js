/**
 * Safe helpers for GrapesJS component model operations (move / index).
 */
...
/**
 * Wrap Layers.render so invalid collection entries are purged before GrapesJS builds views.
 *
 * @param {object} editor
 */
/**
