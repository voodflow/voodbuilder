...
async function loadCounterHelpers() {
    return import('./grapesjs-animated-blocks.js');
}
...
export function applyItemsRootColumnVar(root, columns) {
    ...
    // Persist CSS var on the model for reload/export. GrapesJS setStyle often
    ...
    paintCanvas();
    // GrapesJS may re-render the view after attribute/class updates — repaint after.
