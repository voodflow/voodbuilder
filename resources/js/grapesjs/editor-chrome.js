...
export const STYLE_MANAGER_SECTORS = [
    ...
    },
    {
        ...
        properties: [
            ...
            { property: 'color', important: true, defaults: '#000000' },
    ...
    },
    {
        ...
        extendBuilded: true,
        properties: [
            { property: 'background-color', important: true, defaults: '#ffffff' },
            ...
            { property: 'fill', important: true, defaults: '#000000' },
            { property: 'stroke', important: true, defaults: '#000000' },
        ],
    },
    {
        name: 'Extra',
