...
export function scopeComponentCssToInstance(css, componentId) {
    ...
    let scoped = normalizedCss.replace(
        /:where\(\.voodbuilder-gjs-component-instance,\s*\.voodbuilder-component-rendered,\s*\.VPRichPage\)\s*:where\(\.voodbuilder-pasted-component\)/g,
        `${scope} .voodbuilder-pasted-component`,
    );

    scoped = scoped.replace(
        /\.dark\s+:where\(\.voodbuilder-gjs-component-instance,\s*\.voodbuilder-component-rendered,\s*\.VPRichPage\)\s*:where\(\.voodbuilder-pasted-component\)/g,
