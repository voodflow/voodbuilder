...
export function registerEditorPanelResize(shellOrApi, labels = {}) {
    ...
    const left = rootShell.querySelector('.voodbuilder-gjs-shell__left');
    const right = rootShell.querySelector('.voodbuilder-gjs-shell__right');
    ...
    const apply = () => {
        ...
        right.style.setProperty('--voodbuilder-gjs-inspector-width', `${rightRem}rem`);
    ...
    const makeHandle = (side) => {
        ...
        handle.className = `voodbuilder-gjs-panel-resize voodbuilder-gjs-panel-resize--${side}`;
        ...
        const onUp = () => {
            ...
            dragging = false;
            document.body.classList.remove('voodbuilder-gjs-is-resizing-panel');
        ...
        handle.addEventListener('pointerdown', (event) => {
            ...
            document.body.classList.add('voodbuilder-gjs-is-resizing-panel');
