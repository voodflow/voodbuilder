/**
 * Optional Editor Tailwind CSS plugin wrapper (not loaded by default).
 *
 * The editor canvas already uses pre-built `section-utilities.css` via Vite.
 * Enable this only if you explicitly add `registerEditorTailwindPlugin` to the
...
const grapesjsTailwind = resolveEditorTailwindPlugin(tailwindPluginModule);
