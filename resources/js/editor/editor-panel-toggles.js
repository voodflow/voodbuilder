...
export function registerEditorPanelToggles(shell, labels = {}, toolsMount = null) {
    ...
    const leftAside = rootShell.querySelector('.voodbuilder-editor-shell__left');
    const rightAside = rootShell.querySelector('.voodbuilder-editor-shell__right');
    ...
    const applyVisibility = () => {
        rootShell.classList.toggle('voodbuilder-editor-shell--left-hidden', ! leftVisible);
        rootShell.classList.toggle('voodbuilder-editor-shell--right-hidden', ! rightVisible);
