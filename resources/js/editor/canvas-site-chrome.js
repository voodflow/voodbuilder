/**
 * Boot site header interactions inside the Editor canvas iframe.
 *
 * Static import (not dynamic): shared site-chrome-runtime must not become an
 * async chunk of editor/init.js, or public site-runtime would modulepreload Editor.
 */
...
export function registerCanvasSiteChrome(editor) {
    ...
    // Keep Editor component model in sync when the runtime toggles the drawer,
