/**
 * Normalize Editor color inputs — HTML color inputs require #rrggbb, not named colors.
 */
...
/**
 * Patch HTMLInputElement.prototype.value once so Editor StyleManager never
...
export function installGlobalColorInputValueFix() {
    ...
    // Editor sometimes sets value before type="color". Normalize on type change too.
