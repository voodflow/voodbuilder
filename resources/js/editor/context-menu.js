...
function ensureMenu() {
    ...
    menu.className = 'voodbuilder-editor-context-menu';
...
function createMenuItemButton(item, context) {
    ...
    button.type = 'button';
    button.className = 'voodbuilder-editor-context-menu__item';
    button.setAttribute('role', 'menuitem');
    button.disabled = Boolean(item.disabled);

    if (item.danger) {
        button.classList.add('voodbuilder-editor-context-menu__item--danger');
    }

    if (Array.isArray(item.children) && item.children.length > 0) {
        button.classList.add('voodbuilder-editor-context-menu__item--submenu');
        ...
        chevron.className = 'voodbuilder-editor-context-menu__chevron';
...
function createSeparator() {
    ...
    separator.className = 'voodbuilder-editor-context-menu__separator';
...
function createSubmenu(item, context) {
    ...
    wrap.className = 'voodbuilder-editor-context-menu__submenu-wrap';

    const trigger = createMenuItemButton(item, context);
    const submenu = document.createElement('div');
    submenu.className = 'voodbuilder-editor-context-menu voodbuilder-editor-context-menu--submenu';
