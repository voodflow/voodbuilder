...
function renderCurrentBindingSummary(currentEl, bindingKey, catalog, previewValues, labels) {
    ...
    if (formatted?.kind === 'image') {
        ...
        label.className = 'voodbuilder-editor-dynamic-panel__current-filename';
    ...
    if (formatted?.kind === 'link') {
        ...
        link.className = 'voodbuilder-editor-dynamic-panel__current-link';
...
/**
 * Editor forms "button" uses a Text trait, not inline editing.
...
function applyBindingToComponent(editor, component, bindingKey, option, labels = {}) {
    ...
    if (interactive && fieldType === 'url') {
        ...
        bindTarget.addClass('voodbuilder-editor-bound');
...
function clearBindingFromComponent(component) {
    ...
    component.removeClass('voodbuilder-editor-bound');
...
function configureBoundComponent(editor, component, catalog) {
    ...
    if (interactive && fieldType === 'text') {
        ...
        component.addClass('voodbuilder-editor-bound');
...
function createBindingPanelHtml({ includeModalChrome = false } = {}) {
    const panel = `
            <div class="voodbuilder-editor-dynamic-panel">
                <p class="voodbuilder-editor-dynamic-panel__hint" data-bind-hint></p>
                <p class="voodbuilder-editor-dynamic-panel__current" hidden></p>
                <div class="voodbuilder-editor-dynamic-panel__field-bind" data-field-bind-panel>
                    <label class="voodbuilder-editor-bindings-modal__label">
                        <span class="voodbuilder-editor-bindings-modal__label-text" data-bind-source-label></span>
                        <select class="voodbuilder-editor-bindings-modal__select" data-bind-source></select>
                    </label>
                    <label class="voodbuilder-editor-bindings-modal__label" data-bind-field-search-wrap>
                        <span class="voodbuilder-editor-bindings-modal__label-text" data-bind-field-search-label></span>
                        <input type="search" class="voodbuilder-editor-bindings-modal__input" data-bind-field-search autocomplete="off" />
                    </label>
                    <label class="voodbuilder-editor-bindings-modal__label">
                        <span class="voodbuilder-editor-bindings-modal__label-text" data-bind-field-label></span>
                        <select class="voodbuilder-editor-bindings-modal__select" data-bind-field disabled></select>
                    </label>
                    <div class="voodbuilder-editor-dynamic-panel__actions">
                        <button type="button" class="voodbuilder-editor-bindings-modal__button voodbuilder-editor-bindings-modal__button--compact" data-bind-clear></button>
                        <button type="button" class="voodbuilder-editor-bindings-modal__button voodbuilder-editor-bindings-modal__button--primary" data-bind-apply hidden></button>
                    </div>
                </div>
                <div class="voodbuilder-editor-dynamic-panel__repeat" data-repeat-panel hidden>
                    <p class="voodbuilder-editor-dynamic-panel__repeat-title"></p>
                    <label class="voodbuilder-editor-bindings-modal__label">
                        <span class="voodbuilder-editor-bindings-modal__label-text" data-repeat-source-label></span>
                        <select class="voodbuilder-editor-bindings-modal__select" data-repeat-source></select>
                    </label>
                    <label class="voodbuilder-editor-bindings-modal__label">
                        <span class="voodbuilder-editor-bindings-modal__label-text" data-repeat-limit-label></span>
                        <input type="number" min="1" max="24" class="voodbuilder-editor-bindings-modal__input" data-repeat-limit value="3" />
                    </label>
                    <label class="voodbuilder-editor-bindings-modal__label">
                        <span class="voodbuilder-editor-bindings-modal__label-text" data-repeat-offset-label></span>
                        <input type="number" min="0" max="100" class="voodbuilder-editor-bindings-modal__input" data-repeat-offset value="0" />
                    </label>
                    <label class="voodbuilder-editor-bindings-modal__label">
                        <span class="voodbuilder-editor-bindings-modal__label-text" data-repeat-sort-label></span>
                        <select class="voodbuilder-editor-bindings-modal__select" data-repeat-sort></select>
                    </label>
                    <label class="voodbuilder-editor-bindings-modal__label">
                        <span class="voodbuilder-editor-bindings-modal__label-text" data-repeat-sort-dir-label></span>
                        <select class="voodbuilder-editor-bindings-modal__select" data-repeat-sort-dir>
                            <option value="desc"></option>
                            <option value="asc"></option>
                        </select>
                    </label>
                    <div data-repeat-filters></div>
                    <p class="voodbuilder-editor-dynamic-panel__hint" data-repeat-template-hint></p>
                    <div class="voodbuilder-editor-dynamic-panel__actions">
                        <button type="button" class="voodbuilder-editor-bindings-modal__button voodbuilder-editor-bindings-modal__button--primary" data-repeat-apply></button>
                        <button type="button" class="voodbuilder-editor-bindings-modal__button voodbuilder-editor-bindings-modal__button--compact" data-repeat-clear></button>
                    </div>
                    <p class="voodbuilder-editor-dynamic-panel__current" data-repeat-current hidden></p>
                </div>
            </div>
    `;
    ...
    return `
        <div class="voodbuilder-editor-bindings-modal__dialog" role="dialog" aria-modal="true">
            <h2 class="voodbuilder-editor-bindings-modal__title" data-bind-modal-title></h2>
            ${panel}
            <div class="voodbuilder-editor-bindings-modal__actions" data-bind-modal-footer>
                <button type="button" class="voodbuilder-editor-bindings-modal__button" data-bind-cancel></button>
            </div>
        </div>
    `;
}
...
function createModal() {
    ...
    overlay.className = 'voodbuilder-editor-bindings-modal';
...
function mountBindingForm(editor, component, catalog, labels, onApplied, { mode = 'inline', mount = null } = {}) {
    ...
    if (groups.length === 0 && ! (listHost && repeatSources.length > 0)) {
        ...
        if (mode === 'inline' && mount) {
            ...
            empty.className = 'voodbuilder-editor-dynamic-panel__empty';
    ...
    const hintEl = host.querySelector('[data-bind-hint]') ?? host.querySelector('.voodbuilder-editor-dynamic-panel__hint');
    ...
    if (repeatPanel) {
        const title = repeatPanel.querySelector('.voodbuilder-editor-dynamic-panel__repeat-title');
    ...
    const currentEl = host.querySelector('.voodbuilder-editor-dynamic-panel__current:not([data-repeat-current])')
        ?? host.querySelector('.voodbuilder-editor-dynamic-panel__current');
        ...
        if (repeatSources.length > 0 && listHost) {
            ...
            const populateRepeatFilters = (repeatSourceId, selectedFilters = {}) => {
                ...
                for (const definition of definitions) {
                    ...
                    label.className = 'voodbuilder-editor-bindings-modal__label';

                    const labelText = document.createElement('span');
                    labelText.className = 'voodbuilder-editor-bindings-modal__label-text';
                    labelText.textContent = definition.label ?? definition.id;

                    const select = document.createElement('select');
                    select.className = 'voodbuilder-editor-bindings-modal__select';
...
function mountDynamicInspectorPanel(editor, mount, catalog, labels, previewOptions) {
    ...
    const renderPluginRequired = () => {
        ...
        mount.appendChild(createInspectorEmptyState({
            classNameExtra: 'voodbuilder-editor-dynamic-panel__empty voodbuilder-editor-dynamic-panel__locked',
            title: labels.pluginRequiredTitle ?? 'Voodbuilder Dynamics',
            message: labels.pluginRequiredBody
                ?? 'Connect page content to your models. Requires the Voodbuilder Dynamics plugin.',
            labels,
    ...
    const renderPanel = () => {
        ...
        if (! selected) {
            mount.appendChild(createInspectorEmptyState({
                classNameExtra: 'voodbuilder-editor-dynamic-panel__empty',
                labels,
            }));
        ...
        if (selectionNotice !== null) {
            mount.appendChild(createInspectorEmptyState({
                classNameExtra: 'voodbuilder-editor-dynamic-panel__empty voodbuilder-editor-chrome-layout-notice',
        ...
        try {
            const values = await loadBindingsPreview(
                ...
                if (! editor.__voodbuilderBindingPreviewErrorLogged) {
                    ...
                    console.error('Voodbuilder Editor: could not load binding preview.', error);
                    window.setTimeout(() => {
...
export async function registerBindingsUi(editor, options = {}) {
    ...
    const loadedCatalog = await loadBindingsCatalog(options.bindingsUrl).catch((error) => {
        console.error('Voodbuilder Editor: could not load bindings catalog.', error);
