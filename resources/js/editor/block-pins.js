...
function cloneBlockAsPinned(editor, sourceId) {
    ...
    blockManager.add(aliasId, {
        ...
        attributes: {
            ...
            class: 'voodbuilder-editor-pinned-block',
...
function decorateBlockPins(editor, mount, pinnedIds, labels = {}) {
    ...
    mount.querySelectorAll('.gjs-block').forEach((blockEl) => {
        ...
        if (! sourceId || ! isPinnableBlock(editor, sourceId)) {
            blockEl.querySelector('.voodbuilder-editor-block-pin')?.remove();
        ...
        let button = blockEl.querySelector('.voodbuilder-editor-block-pin');

        if (! button) {
            button = document.createElement('button');
            button.type = 'button';
            button.className = 'voodbuilder-editor-block-pin';
