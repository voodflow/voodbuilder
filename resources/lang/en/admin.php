...
return [
    ...
    'helpers' => [
        ...
        'excerpt' => 'Short summary for section listings and cards. Also used as meta description when the SEO tab is empty.',
        'seo_section' => 'Optional overrides for search engines and social previews. Leave blank to use the page title, excerpt, and site SEO defaults.',
        'seo_title' => 'Leave blank to use the page title.',
        'seo_description' => 'Leave blank to use the excerpt, then the site default description.',
        'seo_robots' => 'Leave blank for the site default, unless the page is gated (then noindex applies automatically).',
        'seo_canonical' => 'Leave blank to use this page’s public URL.',
