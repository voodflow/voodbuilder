...
return [
    ...
    'helpers' => [
        ...
        'menu_tree' => 'Use the grip icon (☰) to drag items and reorder them, or drop an item onto another to nest it as a submenu. Nested items show a colored left rail. Maximum 2 levels (top-level and sub-items). Use "Dropdown group" for labels without a link.',
        'menu_tree_drag' => 'Drag to reorder or nest',
