...
return [
    ...
    'empty' => '<p class="text-sm text-gray-600 dark:text-gray-400">No content channels are registered yet. Install a package such as vdocs, vtuts, or vevents, or register channels in <code>config/vpress.php</code>.</p>',
