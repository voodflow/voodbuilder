...
return [
    ...
    'footer' => [
        ...
        'legacy_menu_placement' => 'Menu footer raggruppato (legacy)',
        'legacy_menu_placement_help' => 'Fallback se i menu per colonna sono vuoti. Ogni gruppo di primo livello diventa una colonna.',
        ...
        'column_placement' => 'Colonna footer landing :number',
        'column_default' => 'Colonna :number',
        'column_title' => 'Titolo colonna :number',
        'column_title_help' => 'Sostituisce il nome del menu con posizione :placement.',
    ...
    'layouts' => [
        ...
        'full_width_help' => 'Contenuto pagina a tutta larghezza (edge-to-edge). L’area di editing resta sempre full-width. Nascondi nav/footer del sito se la pagina ha il proprio chrome.',
    ...
    'navbar' => [
        ...
        'logo' => 'Logo navbar',
        'logo_help' => 'Logo opzionale accanto al nome brand.',
        'brand_name' => 'Nome brand',
        'menu_placement' => 'Menu navbar',
        'menu_placement_help' => 'Gestisci i link in Admin → Menu con posizione "Link navbar landing".',
        'default_menu' => 'Link navbar landing',
        'cta_label' => 'Etichetta pulsante CTA',
        'cta_url' => 'URL pulsante CTA',
    ],
];
