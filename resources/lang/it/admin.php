...
return [
    ...
    'helpers' => [
        ...
        'excerpt' => 'Breve riassunto per elenchi di sezione e card. Usato anche come meta description se la tab SEO è vuota.',
        'seo_section' => 'Override opzionali per motori di ricerca e anteprime social. Lascia vuoto per usare titolo, estratto e default SEO del sito.',
        'seo_title' => 'Lascia vuoto per usare il titolo della pagina.',
        'seo_description' => 'Lascia vuoto per usare l’estratto, poi la description predefinita del sito.',
        'seo_robots' => 'Lascia vuoto per il default del sito, salvo pagine gated (noindex automatico).',
        'seo_canonical' => 'Lascia vuoto per usare l’URL pubblico di questa pagina.',
