...
return [
    ...
    'helpers' => [
        ...
        'menu_tree' => 'Usa l’icona grip (☰) per trascinare e riordinare le voci, oppure rilascia una voce su un’altra per annidarla come sottomenu. Le voci figlie hanno una barra colorata a sinistra. Massimo 2 livelli (principale + sotto-voci). Usa "Gruppo dropdown" per etichette senza link.',
        'menu_tree_drag' => 'Trascina per riordinare o annidare',
