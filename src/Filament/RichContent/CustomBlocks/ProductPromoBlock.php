...
/**
 * Rich content / landing block: Product Promo Block.
 */
class ProductPromoBlock extends RichContentCustomBlock
{
    ...
    {
        return RichContentBlockPreview::render('voodbuilder::blocks.product-promo', ['config' => $config]);
    }

    public static function toHtml(array $config, array $data): string
    {
        return view('voodbuilder::blocks.product-promo', ['config' => $config])->render();
    }
}
