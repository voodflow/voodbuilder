...
final class ConfigureSubThemesForVpress
{
    ...
    protected static function replaceSubThemesBlock(string $contents, array $subThemes): string
    {
        ...
        if ($bounds === null) {
            ...
            if (! is_string($updated)) {
                throw new \RuntimeException('Unable to update config/vpress.php.');
            }
    ...
    protected static function findMatchingCloseBracket(string $contents, int $openPos): int
    {
        ...
        throw new \RuntimeException('Unbalanced array brackets in config/vpress.php.');
    }
    ...
    protected static function normalizeStoredDefinition(string $id, array $definition): array
    {
        ...
        return [
            ...
            'layouts' => [
                'home' => (string) ($layouts['home'] ?? "vpress.themes.{$id}.layouts.home"),
                'landing' => (string) ($layouts['landing'] ?? "vpress.themes.{$id}.layouts.landing"),
                'page' => (string) ($layouts['page'] ?? "vpress.themes.{$id}.layouts.page"),
                ...array_filter([
            ...
            'css' => (string) ($definition['css'] ?? "resources/vpress/themes/{$id}/theme.css"),
            ...(
