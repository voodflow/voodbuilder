...
/**
 * Editor HTML payload mirroring the Soundmit exhibitor landing (soundmit.com).
 */
final class SoundmitEditorLanding
{
    /**
...
HTML;
    ...
    {
        $path = VoodbuilderPaths::packagePath().'/resources/editor/soundmit-landing-catalog.html';
