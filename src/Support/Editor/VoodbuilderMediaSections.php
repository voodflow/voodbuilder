...
HTML;
    ...
    {
        $poster = EditorPlaceholderNormalizer::neutralImageDataUri();

        return <<<HTML
<section class="voodbuilder-editor-section relative overflow-hidden bg-zinc-950 text-white" data-voodbuilder-section-block="vb-bg-video" data-vb-video-src="" data-vb-video-poster="" data-vb-controls="0" data-vb-muted="1" data-vb-autoplay="1" data-vb-loop="1" data-vb-min-height="70vh" style="min-height:70vh;">
  <div class="voodbuilder-hero-media" data-voodbuilder-role="media" aria-hidden="true" style="position:absolute;inset:0;overflow:hidden;">
    <video class="voodbuilder-hero-media__video" poster="{$poster}" muted autoplay loop playsinline style="position:absolute;inset:0;display:block;width:100%;height:100%;max-width:none;object-fit:cover;object-position:center;"></video>
    <div class="voodbuilder-hero-media__shade bg-gradient-to-t from-zinc-950 via-zinc-950/70 to-zinc-950/30 lg:bg-gradient-to-r lg:from-zinc-950 lg:via-zinc-950/80 lg:to-transparent" data-voodbuilder-role="shade" style="pointer-events:none;position:absolute;inset:0;"></div>
  </div>
  <div class="voodbuilder-editor-container relative z-10 flex items-end px-5 pb-16 pt-28 lg:items-center lg:pb-24" data-voodbuilder-role="content" style="min-height:70vh;">
    <div class="max-w-3xl">
...
HTML;
    ...
    public static function sliderImages(): string
    {
        ...
        return <<<HTML
<section class="voodbuilder-editor-section bg-vp-bg px-5 py-20 text-vp-text-2" data-voodbuilder-section-block="vb-slider-images">
...
HTML;
    ...
    public static function sliderVideos(): string
    {
        ...
        return <<<HTML
<section class="voodbuilder-editor-section bg-vp-bg-alt px-5 py-20 text-vp-text-2" data-voodbuilder-section-block="vb-slider-videos">
  <div class="voodbuilder-editor-container">
