...
final class VoodbuilderLanding03Sections
{
    ...
    public static function hero(): string
    {
        ...
        return <<<HTML
<section class="voodbuilder-editor-section relative overflow-hidden bg-zinc-950 text-white" data-voodbuilder-section-block="vb-nasa-hero" data-vb-bg-size="cover" data-vb-bg-position="center" data-vb-bg-opacity="0.55" data-vb-bg-src="" style="min-height:70vh;">
...
HTML;
    ...
    {
        return <<<'HTML'
<section class="voodbuilder-editor-section relative z-20 -mt-10 bg-vp-bg-alt px-5 py-10 text-vp-text-2 lg:py-14" data-voodbuilder-section-block="vb-nasa-stats" aria-label="VoodBuilder statistics">
...
HTML;
    ...
    public static function featured(): string
    {
        ...
        return <<<HTML
<section class="voodbuilder-editor-section bg-vp-bg px-5 py-20 text-vp-text-2" data-voodbuilder-section-block="vb-nasa-featured">
  <div class="voodbuilder-editor-container">
...
HTML;
    ...
    public static function teaser(): string
    {
        ...
        return <<<HTML
<section class="voodbuilder-editor-section bg-vp-bg px-5 pb-20 text-vp-text-2" data-voodbuilder-section-block="vb-nasa-teaser">
  <div class="voodbuilder-editor-container">
...
HTML;
    ...
    public static function spotlight(): string
    {
        ...
        return <<<HTML
<section class="voodbuilder-editor-section bg-vp-bg-alt px-5 py-20 text-vp-text-2" data-voodbuilder-section-block="vb-nasa-spotlight">
  <div class="voodbuilder-editor-container grid items-center gap-12 lg:grid-cols-2">
    <div>
...
HTML;
    ...
    public static function missions(): string
    {
        ...
        return <<<HTML
<section class="voodbuilder-editor-section bg-zinc-950 px-5 py-20 text-white" data-voodbuilder-section-block="vb-nasa-missions">
  <div class="voodbuilder-editor-container">
...
HTML;
    ...
    public static function explore(): string
    {
        ...
        return <<<HTML
<section class="voodbuilder-editor-section bg-vp-bg px-5 py-20 text-vp-text-2" data-voodbuilder-section-block="vb-nasa-explore">
  <div class="voodbuilder-editor-container">
