...
/**
 * Editor Import Compatibility Analyzer.
 */
final class EditorImportCompatibilityAnalyzer
{
    /**
    ...
    {
        $rawClasses = EditorImportedTailwindSupport::extractClassNames($rawHtml);
        $normalizedClasses = EditorImportedTailwindSupport::extractClassNames($normalizedHtml);
    ...
    /**
     * Voodbuilder / Editor chrome classes (vb-*, voodbuilder-*) are styled outside block JIT.
     */
