...
final class EditorGate
{
    ...
    public static function sharedEditorLabels(): array
    {
        $labels = [
            ...
            'statusSaved' => __('voodbuilder::pro.frontend.status.saved'),
            'statusSaving' => __('voodbuilder::pro.frontend.status.saving'),
            'statusUnsaved' => __('voodbuilder::pro.frontend.status.unsaved'),
            'statusDraftAt' => __('voodbuilder::pro.frontend.status.draft_at'),
            'statusDraftHint' => __('voodbuilder::pro.frontend.status.draft_hint'),
            ...
            'classStyleBackgroundSize' => __('voodbuilder::pro.editor_ui.class_style_background_size'),
            'classStyleBackgroundPosition' => __('voodbuilder::pro.editor_ui.class_style_background_position'),
            ...
            'classStyleGradientStopFrom' => __('voodbuilder::pro.editor_ui.class_style_gradient_stop_from'),
            'classStyleGradientStopVia' => __('voodbuilder::pro.editor_ui.class_style_gradient_stop_via'),
            'classStyleGradientStopTo' => __('voodbuilder::pro.editor_ui.class_style_gradient_stop_to'),
            ...
            'tabReading' => __('voodbuilder::pro.editor_ui.tab_reading'),
            'readingTabTitle' => __('voodbuilder::pro.editor_ui.reading_tab_title'),
            'readingTabHint' => __('voodbuilder::pro.editor_ui.reading_tab_hint'),
            'readingPreviewSample' => __('voodbuilder::pro.editor_ui.reading_preview_sample'),
            'readingHeadingFont' => __('voodbuilder::pro.editor_ui.reading_heading_font'),
            'readingBodyFont' => __('voodbuilder::pro.editor_ui.reading_body_font'),
            'readingInheritSiteFont' => __('voodbuilder::pro.editor_ui.reading_inherit_site_font'),
            'readingInheritValue' => __('voodbuilder::pro.editor_ui.reading_inherit_value'),
            ...
            'readingWeight' => __('voodbuilder::pro.editor_ui.reading_weight'),
            'readingLineHeight' => __('voodbuilder::pro.editor_ui.reading_line_height'),
            'readingReset' => __('voodbuilder::pro.editor_ui.reading_reset'),
            'readingResetTitle' => __('voodbuilder::pro.editor_ui.reading_reset_title'),
            'chromeLayoutStructureInspectorNotice' => __('voodbuilder::pro.editor_ui.chrome_layout_structure_inspector_notice'),            'chromeLayoutContentSlotInspectorNotice' => __('voodbuilder::pro.editor_ui.chrome_layout_content_slot_inspector_notice'),
            ...
            'classStyleViewportHint' => __('voodbuilder::pro.editor_ui.class_style_viewport_hint'),
            'classStyleViewportEditing' => __('voodbuilder::pro.editor_ui.class_style_viewport_editing'),
            ...
            'bootPhaseShell' => __('voodbuilder::pro.editor_ui.boot_phase_shell'),
            'bootPhaseCanvas' => __('voodbuilder::pro.editor_ui.boot_phase_canvas'),
            ...
            'applyingStyles' => __('voodbuilder::pro.editor_ui.applying_styles'),
            'editionInfo' => __('voodbuilder::pro.editor_ui.edition_info'),
            'editionInfoEdition' => __('voodbuilder::pro.editor_ui.edition_info_edition'),
            ...
            'editionInfoPackages' => __('voodbuilder::pro.editor_ui.edition_info_packages'),
            'editionInfoPkgName' => __('voodbuilder::pro.editor_ui.edition_info_pkg_name'),
            'editionInfoPkgVersion' => __('voodbuilder::pro.editor_ui.edition_info_pkg_version'),
            'editionInfoPkgActiveCol' => __('voodbuilder::pro.editor_ui.edition_info_pkg_active_col'),
            'editionInfoPkgRegisteredCol' => __('voodbuilder::pro.editor_ui.edition_info_pkg_registered_col'),
            'editionInfoPkgYes' => __('voodbuilder::pro.editor_ui.edition_info_pkg_yes'),
            'editionInfoPkgNo' => __('voodbuilder::pro.editor_ui.edition_info_pkg_no'),
            'editionInfoPkgMissing' => __('voodbuilder::pro.editor_ui.edition_info_pkg_missing'),
            'editionInfoPkgActive' => __('voodbuilder::pro.editor_ui.edition_info_pkg_active'),
            'editionInfoPkgInactive' => __('voodbuilder::pro.editor_ui.edition_info_pkg_inactive'),
            'editionInfoPkgNa' => __('voodbuilder::pro.editor_ui.edition_info_pkg_na'),
            'editionInfoGroupCore' => __('voodbuilder::pro.editor_ui.edition_info_group_core'),
            'editionInfoGroupEdition' => __('voodbuilder::pro.editor_ui.edition_info_group_edition'),
            'editionInfoGroupExtra' => __('voodbuilder::pro.editor_ui.edition_info_group_extra'),
            'editionInfoGroupAgency' => __('voodbuilder::pro.editor_ui.edition_info_group_agency'),
            'editionInfoGroupDeveloper' => __('voodbuilder::pro.editor_ui.edition_info_group_developer'),
            'editionInfoClose' => __('voodbuilder::pro.editor_ui.edition_info_close'),
            ...
            'contextInsertBasic' => __('voodbuilder::pro.editor.context_insert_basic'),
            'contextInsertMedia' => __('voodbuilder::pro.editor.context_insert_media'),
            'contextInsertHeading' => __('voodbuilder::pro.editor.context_insert_heading'),
            'contextInsertBasicText' => __('voodbuilder::pro.editor.context_insert_basic_text'),
            'contextInsertRichText' => __('voodbuilder::pro.editor.context_insert_rich_text'),
            ...
            'contextInsertCodeBlock' => __('voodbuilder::pro.editor.context_insert_code_block'),
            'contextInsertImage' => __('voodbuilder::pro.editor.context_insert_image'),
            'contextInsertVideo' => __('voodbuilder::pro.editor.context_insert_video'),
            'contextInsertImageGallery' => __('voodbuilder::pro.editor.context_insert_image_gallery'),
            ...
            'pageTemplatesApplyingStyles' => __('voodbuilder::pro.page_templates.applying_styles'),
            'pageTemplatesSaving' => __('voodbuilder::pro.page_templates.saving'),
            'pageTemplatesSavingServer' => __('voodbuilder::pro.page_templates.saving_server'),
            ...
            'layoutProgressZonePlaceholder' => __('voodbuilder::chrome_layouts.editor.layout_progress_zone_placeholder'),
            ...
            'footerShowLogoDesktop' => __('voodbuilder::pro.editor.footer_settings.show_logo_desktop'),
            'footerShowLogoMobile' => __('voodbuilder::pro.editor.footer_settings.show_logo_mobile'),
            'footerShowSiteName' => __('voodbuilder::pro.editor.footer_settings.show_site_name'),
            'footerShowSiteNameDesktop' => __('voodbuilder::pro.editor.footer_settings.show_site_name_desktop'),
            'footerShowSiteNameMobile' => __('voodbuilder::pro.editor.footer_settings.show_site_name_mobile'),
            ...
            'footerTagline' => __('voodbuilder::pro.editor.footer_settings.tagline'),
            'footerTaglinePlaceholder' => __('voodbuilder::pro.editor.footer_settings.tagline_placeholder'),
            'footerCopyright' => __('voodbuilder::pro.editor.footer_settings.copyright'),
            'footerCopyrightPlaceholder' => __('voodbuilder::pro.editor.footer_settings.copyright_placeholder'),
            'footerCopyTagsHelp' => __('voodbuilder::pro.editor.footer_settings.copy_tags_help'),
            ...
            'logoShape' => __('voodbuilder::pro.editor.footer_settings.logo_shape'),
            'logoShapeNatural' => __('voodbuilder::pro.editor.footer_settings.logo_shape_natural'),
            'logoShapeCircle' => __('voodbuilder::pro.editor.footer_settings.logo_shape_circle'),
            ...
            'navShowLogoDesktop' => __('voodbuilder::pro.editor.nav_settings.show_logo_desktop'),
            'navShowLogoMobile' => __('voodbuilder::pro.editor.nav_settings.show_logo_mobile'),
            'navShowSiteName' => __('voodbuilder::pro.editor.nav_settings.show_site_name'),
            'navShowSiteNameDesktop' => __('voodbuilder::pro.editor.nav_settings.show_site_name_desktop'),
            'navShowSiteNameMobile' => __('voodbuilder::pro.editor.nav_settings.show_site_name_mobile'),
            ...
            'buttonLinkTypeMail' => __('voodbuilder::pro.editor.button_link.type_mail'),
            'buttonLinkTypeRoute' => __('voodbuilder::pro.editor.button_link.type_route'),
            'buttonLinkPage' => __('voodbuilder::pro.editor.button_link.page'),
            'buttonLinkMenu' => __('voodbuilder::pro.editor.button_link.menu'),
            'buttonLinkMail' => __('voodbuilder::pro.editor.button_link.mail'),
            'buttonLinkMailPlaceholder' => __('voodbuilder::pro.editor.button_link.mail_placeholder'),
            'buttonLinkMailSubject' => __('voodbuilder::pro.editor.button_link.mail_subject'),
            'buttonLinkMailSubjectPlaceholder' => __('voodbuilder::pro.editor.button_link.mail_subject_placeholder'),
            'buttonLinkRoute' => __('voodbuilder::pro.editor.button_link.route'),
