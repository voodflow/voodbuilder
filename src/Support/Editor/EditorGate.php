...
final class EditorGate
{
    ...
    public static function sharedEditorLabels(): array
    {
        $labels = [
            ...
            'readingPrimaryFont' => __('voodbuilder::pro.editor_ui.reading_primary_font'),
            'readingSecondaryFont' => __('voodbuilder::pro.editor_ui.reading_secondary_font'),
            'readingBaseSize' => __('voodbuilder::pro.editor_ui.reading_base_size'),
            'readingTypeScale' => __('voodbuilder::pro.editor_ui.reading_type_scale'),
            'readingSecondaryTypeScale' => __('voodbuilder::pro.editor_ui.reading_secondary_type_scale'),
