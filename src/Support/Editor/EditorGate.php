...
final class EditorGate
{
    ...
    public static function sharedEditorLabels(): array
    {
        $labels = [
            ...
            'editionInfoPkgLatest' => __('voodbuilder::pro.editor_ui.edition_info_pkg_latest'),
            'editionInfoPkgStatus' => __('voodbuilder::pro.editor_ui.edition_info_pkg_status'),
            ...
            'editionInfoGroupCompanion' => __('voodbuilder::pro.editor_ui.edition_info_group_companion'),
            'editionInfoGroupOther' => __('voodbuilder::pro.editor_ui.edition_info_group_other'),
