...
final class EditorGate
{
    ...
    public static function sharedEditorLabels(): array
    {
        $labels = [
            ...
            'editionInfoPkgChannel' => __('voodbuilder::pro.editor_ui.edition_info_pkg_channel'),
            ...
            'editionInfoGroupPackagist' => __('voodbuilder::pro.editor_ui.edition_info_group_packagist'),
            'editionInfoGroupAnystackBundle' => __('voodbuilder::pro.editor_ui.edition_info_group_anystack_bundle'),
            'editionInfoGroupAnystackCompanion' => __('voodbuilder::pro.editor_ui.edition_info_group_anystack_companion'),
