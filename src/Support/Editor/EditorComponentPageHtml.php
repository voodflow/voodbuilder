...
/**
 * Editor Component Page Html.
 */
final class EditorComponentPageHtml
{
    /**
     * @return list<string>
     */
    ...
    {
        if ($pageHtml === '' || ! str_contains($pageHtml, 'data-voodbuilder-editor-site-header')) {
            return $pageHtml;
        }

        $document = self::loadDocument($pageHtml);
        $xpath = new DOMXPath($document);
        $nodes = $xpath->query('//*[@data-voodbuilder-editor-site-header]');
