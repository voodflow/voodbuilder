...
final class VoodbuilderLanding01Sections
{
    ...
    {
        return <<<'HTML'
<section class="voodbuilder-editor-section relative bg-vp-bg text-vp-text-2" data-voodbuilder-section-block="vb-landing01-hero">
  ...
  <div class="voodbuilder-editor-container relative px-5 pb-16 pt-28">
...
HTML;
    ...
    {
        return <<<'HTML'
<section class="voodbuilder-editor-section bg-vp-bg py-20 text-vp-text-2" data-voodbuilder-section-block="vb-landing01-features">
...
HTML;
    ...
    public static function solution(): string
    {
        ...
        return <<<HTML
<section class="voodbuilder-editor-section bg-vp-bg-alt py-20 text-vp-text-2" data-voodbuilder-section-block="vb-landing01-solution">
  <div class="voodbuilder-editor-container px-5">
...
HTML;
    ...
    public static function testimonials(): string
    {
        ...
        return <<<HTML
<section class="voodbuilder-editor-section bg-vp-bg py-20 text-vp-text-2" data-voodbuilder-section-block="vb-landing01-testimonials">
  <div class="voodbuilder-editor-container px-5">
