...
final class VoodbuilderLanding02Sections
{
    ...
    public static function hero(): string
    {
        ...
        return <<<HTML
<section class="voodbuilder-gjs-section bg-vp-bg-alt px-5 py-24 text-vp-text-2" data-voodbuilder-section-block="vb-landing02-hero">
...
HTML;
    ...
    {
        return <<<'HTML'
<section class="voodbuilder-gjs-section bg-vp-bg px-5 py-20 text-vp-text-2" data-voodbuilder-section-block="vb-landing02-trust">
  <div class="voodbuilder-gjs-container">
...
HTML;
    ...
    {
        return <<<'HTML'
<section class="voodbuilder-gjs-section bg-vp-bg px-5 py-24 text-vp-text-2" data-voodbuilder-section-block="vb-landing02-features">
  <div class="voodbuilder-gjs-container">
...
HTML;
    ...
    public static function impact(): string
    {
        ...
        return <<<HTML
<section class="voodbuilder-gjs-section bg-vp-bg-alt px-5 py-24 text-vp-text-2" data-voodbuilder-section-block="vb-landing02-impact">
  <div class="voodbuilder-gjs-container">
...
HTML;
    ...
    {
        return <<<'HTML'
<section class="voodbuilder-gjs-section bg-vp-bg px-5 py-24 text-vp-text-2" data-voodbuilder-section-block="vb-landing02-toolkit">
  <div class="voodbuilder-gjs-container">
...
HTML;
    ...
    public static function articles(): string
    {
        ...
        return <<<HTML
<section class="voodbuilder-gjs-section bg-vp-bg px-5 py-24 text-vp-text-2" data-voodbuilder-section-block="vb-landing02-articles">
  <div class="voodbuilder-gjs-container">
...
HTML;
    ...
    {
        return <<<'HTML'
<section class="voodbuilder-gjs-section bg-vp-bg-alt px-5 py-20 text-vp-text-2" data-voodbuilder-section-block="vb-landing02-faq">
  <div class="voodbuilder-gjs-container">
