    ...
    public static function definitions(): array
    {
        return [
            [
                ...
                'html' => GrapesJsSmartButtonAnnotator::annotate(VoodbuilderLanding01Sections::pageHtml()),
                'css' => null,
                'js' => null,
            ],
            [
                ...
                'html' => GrapesJsSmartButtonAnnotator::annotate(VoodbuilderLanding02Sections::pageHtml()),
                'css' => null,
                'js' => null,
            ],
            [
                ...
                'html' => GrapesJsSmartButtonAnnotator::annotate(VoodbuilderLanding03Sections::pageHtml()),
                'css' => null,
                'js' => null,
            ],
        ];
