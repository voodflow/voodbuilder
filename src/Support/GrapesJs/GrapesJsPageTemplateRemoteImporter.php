...
final class GrapesJsPageTemplateRemoteImporter
{
    ...
    public static function fetchBundle(string $url): array
    {
        ...
        GrapesJsPageTemplateBundle::assertImportable($decoded);
    ...
    public static function fetchCatalog(string $url): array
    {
        ...
        $entries = GrapesJsPageTemplateBundle::extractCatalogEntries($decoded);
