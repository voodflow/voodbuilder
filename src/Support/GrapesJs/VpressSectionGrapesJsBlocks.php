...
final class VpressSectionGrapesJsBlocks
{
    ...
    {
        return VpressPaths::packagePath().'/resources/grapesjs/section-blocks.json';
    }

    public static function utilitiesCssEntry(): string
    {
        return VpressPaths::relativeToBasePath(
            VpressPaths::packagePath().'/resources/css/grapesjs/section-utilities.css',
        );
    }
    ...
    {
        if (config('vpress.grapesjs.site_blocks.hide_section_chrome', true)) {
        ...
        $modes = (array) config('vpress.grapesjs.sections.modes', ['adaptive']);
