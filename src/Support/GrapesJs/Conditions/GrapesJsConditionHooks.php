...
final class GrapesJsConditionHooks
{
    ...
    private static function valueMetaFor(string $key): array
    {
        ...
        $configured = config("voodbuilder.grapesjs.conditions.value_meta.{$key}");
    ...
    {
        $explicit = config('voodbuilder.grapesjs.conditions.locales');
    ...
    {
        $explicit = config('voodbuilder.grapesjs.conditions.roles');
