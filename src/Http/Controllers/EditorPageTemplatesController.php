...
class EditorPageTemplatesController extends Controller
{
    ...
    public function import(Request $request): JsonResponse
    {
        ...
        $entries = EditorPageTemplateBundle::extractTemplates($validated['import']);
    ...
    public function importFromUrl(Request $request): JsonResponse
    {
        ...
        $bundle = EditorPageTemplateRemoteImporter::fetchBundle($validated['url']);
        $entries = EditorPageTemplateBundle::extractTemplates($bundle);
    ...
    public function installCatalogEntry(Request $request): JsonResponse
    {
        ...
        $bundle = EditorPageTemplateRemoteImporter::fetchBundle($validated['bundle_url']);
        $entries = EditorPageTemplateBundle::extractTemplates($bundle);
    ...
    public function export(Request $request): JsonResponse
    {
        ...
        $payload = EditorPageTemplateBundle::buildExportPayload($query->get()->all());
    ...
    protected function toArray(PageTemplate $template): array
    {
        return [
            ...
            'html' => EditorSmartButtonAnnotator::annotate((string) ($template->html ?? '')),
            'css' => $template->css ?? '',
            'js' => $template->js ?? '',
