...
/**
 * Server-rendered Editor block for third-party packages (no Filament RichEditor required).
 *
 * Register in your ServiceProvider:
 *   Voodbuilder::editorServerBlock('MyPackage', MyBlock::class);
 */
interface EditorServerBlock
{
